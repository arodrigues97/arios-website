...
<h5 class="sub-head">WildScape Pk Voting</h5>
</div>
<div class="container-one" style="min-height:400px;">
<div class="vote">
<br>
<div class="green-msg"> Voting on the sites below allow you to gain credits. Credits can be used to purchase <i>perks</i> from the <i>WildScape Pk</i> shop located <a href="/donate"><b>here</b></a></div>
<?php $user -> getModule("VotingModule") -> load();?>
</div>
<div class="forms">
<form data-formsite="runelocus" action="http://www.runelocus.com/toplist/index.php" method="get" target="_blank">
<input type="hidden" name="action" value="vote"/>
<input type="hidden" name="id" value="40963"/>
<input type="hidden" name="id2" value="<?php echo $user -> getUsername();?>"/>
</form>
<form data-formsite="rune-server" action="http://www.rune-server.org/toplist.php" method="get" target="_blank">
...
<form data-formsite="topg" action="http://topg.org/Runescape/in-419664-<?php echo $user -> getUsername() ?>" method="get" target="_blank">
</form>
</div>
</div>
<br>
