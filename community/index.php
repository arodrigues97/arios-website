...
<a class="createthread" href="/community/members/index.php?name=<?php echo $user -> getUsername();?>"><i class="fa fa-user"></i> Profile <?php $count = $user -> getNotificationManager() -> getCount(); echo $count > 0 ? "(" . $count . ")" : ""?></a>
