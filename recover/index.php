...
<li>
Please enter the username of the account you would wish to recover. <br><strong>Warning:</strong> Your account must have had a set and validated email in order to complete the recovery process.
<label class="styled-row" for="input" style="margin: 20px auto;"><p>Username:</p><input type="text" class="usernameval" name="username" placeholder="Enter a username to recover" value=""/></label>
