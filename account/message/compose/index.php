...
<input class="recipient" type="text" placeholder="<?php echo isset($_GET['recipient']) ? $_GET['recipient'] : "Enter recipient username" ?>">
...
<script>
    $(document).ready(function() {
        ...
        $(document).delegate(".editor > .core > .send", "click", function() {
            $.post("/lib/sys/ActionHandler.php?action=ModuleAction&name=MessageCentre&modAction=compose", {html: editor.getData(), recipient: $(".recipient").val(), subject: $(".subject").val()}, function(data) {
