...
<h5 class="sub-head">Arios Shop</h5>
</div>
...
<div class='shop-faq'>
<p>The Arios donation system allows for the purchase of perks (in-game enhancement) which last for the lifetime of their account. Perks can be purchased with Arios Credits (earned from voting & other activities) or can be purchased with real world currency.<br></p>
<p><br>When purchasing perks with real world currency, players can earn a donator rank by donating a lifetime total of the following:</p><br><br>
<ul>
<li><span class="username" style="color: #006600;"><img style='margin-right: 1px; margin-top: 1px;' src='/lib/images/icons/regular.png'>Regular Donator</span> - $25 Lifetime Total
<ul>
<li>Donator Zone (bank, furnace, fairy ring, ect)</li>
</ul>
</li>
<li><span class="username" style="color: #990000;"><img style='margin-right: 1px; margin-top: 1px;' src='/lib/images/icons/extreme.png'>Extreme Donator</span> - $50 Lifetime Total
<ul>
...
<p class="quote">The only available things for purchase are located on this page. Arios staff does not individually sell to players.</p>
<p class="shop-faq-header">Do you accept rsgp or rs accounts?</p>
<p class="quote">Arios does not accept rs gold or accounts as a form of payment or donation.</p>
<p class="shop-faq-header">Can I donate for someone else?</p>
<p class="quote">Yes, you may enter a giftee username under the shopping card and proceed as you normally pay.</p>
<p class="shop-faq-header">When/how do I recieve my perks after purchase?</p>
<p class="quote">The perks are automatically credited towards your account within a few minutes of buying. Re-log in-game for them to take effect.</p>
</div>
</div>
</div>
...
$(document).ready(function() {
	...
	$(".checkout").click(function(e) {
		...
		if (isCredits) {
			...
			$.post("/lib/sys/ActionHandler.php?action=ModuleAction&name=ShopModule&modAction=checkout", {arr: arr, giftee: $(".giftee").val()}, function(data) {
				if (data == "SUCCESS") {
