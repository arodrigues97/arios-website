...
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
 ...
 <img src='/lib/images/logo.png' alt='Arios'/>
 <div class="content">
...
<?php } ?>
 ...
 <p class="help"><b>To Register:</b> Download the client and select 'Create an Account' on the main client screen.</p>
 <p class="help"><b>Trouble playing?</b> Head on over to our <a href="/community">Community forums</a> and make a bug report!</p>
 </div>
 <div class="exit"><i class="fa fa-times"></i></div>
 </div>
 <div class='wrapper'>
 ...
 <div class='playercount'>There are currently <?php echo Registry::get("sys") -> getPlayersOnline()?> players online!</div>
 <div class='header'>
