...
class PasswordRecovery extends Action {
	...
	public function handle($cleaned) {
		...
		$user -> sendEmail("Hi " . $user -> getFormatUsername() . "<br><br> We have received a request to reset the password for your Arios account.<br><br>To reset your password, click the link below or copy and paste it into your browser: <br><br> " . VALIDATE_LINK . Registry::get("sys")->getValidationManager()->newValidation($user -> getUsername(), 4) . "<br><br>If you did not submit this password reset request you can safely ignore this email - your account will remain secure.<br>Kind regards,<br>Arios Account Support");
